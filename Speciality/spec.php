  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="inactive"><a href="doc.php">View Doctor(s) <span class="sr-only">(current)</span></a></li>
		...
		<li class="active"><a href="spec.php">View Specialities<span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header">Admin <small>Speciality Records</small> </h1> </center>
