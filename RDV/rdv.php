  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="rdv.php">View or Appoint RDV<span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header"> Admin<small> RDV Records</small></h1> </center>
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="patient" id="patient">
					  ...
					  while ($row4 = $query4->fetch_assoc()) {
						echo "<option value=\"$row4[patientID]\" >".$row4['patientCNI']." | ".$row4['patientLast']." ".$row4['patientFirst']."</option>";
						}
					  ?>
				  </select>
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="service" id="service">
					  ...
					  while ($row5 = $query5->fetch_assoc()) {
						echo "<option value=\"$row5[servID]\" >".$row5['servName']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="doctor" id="doctor">
			      	<option value="">~~SELECT~~</option>
					  <?php
					  $sql6 = "SELECT * FROM Doc JOIN Speciality WHERE Doc.specID = Speciality.specID";
					  $query6 = $connect->query($sql6);
					  while ($row6 = $query6->fetch_assoc()) {
						echo "<option value=\"$row6[docID]\" >".$row6['specName']." | ".$row6['docFirst']." ".$row6['docLast']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
			...
			<div class="form-group"> <!--/here teh addclass has-error will appear -->
			    ...
			    <div class="col-sm-10">
				  ...
				  <option value="">~~SELECT~~</option>
					  ...
					  while ($row1 = $query1->fetch_assoc()) {
						echo "<option value=\"$row1[patientID]\" >".$row1['patientCNI']." | ".$row1['patientLast']." ".$row1['patientFirst']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
			    ...
			    <div class="col-sm-10">
				  ...
				  <option value="">~~SELECT~~</option>
					  ...
					  while ($row2 = $query2->fetch_assoc()) {
						echo "<option value=\"$row2[servID]\" >".$row2['servName']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
				  ...
				  <option value="">~~SELECT~~</option>
					  <?php
					  $sql3 = "SELECT * FROM Doc JOIN Speciality WHERE Doc.specID = Speciality.specID";
					  $query3 = $connect->query($sql3);
					  while ($row3 = $query3->fetch_assoc()) {
						echo "<option value=\"$row3[docID]\" >".$row3['specName']." | ".$row3['docFirst']." ".$row3['docLast']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
