  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="inactive"><a href="../Doctor/doc_for_doc.php">View Doctor(s) <span class="sr-only">(current)</span></a></li>
		<li class="inactive"><a href="../Patient/patient_for_doc.php">View Patients<span class="sr-only">(current)</span></a></li>
		<li class="active"><a href="rdv_for_doc.php">My Appointments<span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header">My Appointments </h1> </center>
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="patient" id="patient">
					  ...
					  while ($row = $query->fetch_assoc()) {
						echo "<option value=\"$row[patientID]\" >".$row['patientLast']." ".$row['patientFirst']."</option>";
						}
					  ?>
				  </select>
	      ...
	      <div class="modal-body">
			...
			<div class="form-group"> <!--/here teh addclass has-error will appear -->
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
				  ...
				  <option value="">~~SELECT~~</option>
					  ...
					  $query = $connect->query($sql);
					  while ($row = $query->fetch_assoc()) {
						echo "<option value=\"$row[patientID]\" >".$row['patientFirst']." ".$row['patientFirst']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
			  ...
			  <div class="form-group"> <!--/here teh addclass has-error will appear -->
			    ...
			    <div class="col-sm-10"> 
			      <input type="time" class="form-control" id="editRdvTime" name="editRdvTime" placeholder="Time">
				<!-- here the text will apper  -->
			    </div>
			  </div>			 			 		
	      </div>
