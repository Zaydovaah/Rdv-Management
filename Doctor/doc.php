...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
     ...
     <a class="navbar-brand" href="../home.php"><span class="glyphicon glyphicon-hospital" aria-hidden="true"></span> Rdv App</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="doc.php">View Doctor(s) <span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h1 class="page-header">Admin<small> Doctor Records</small> </h1> </center>
