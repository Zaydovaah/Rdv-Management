...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../home.doc.php">Rdv App</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
	    <li class="inactive"><a href="../home.doc.php">Home</a></li>
		<li class="active"><a href="doc_for_doc.php">View Doctor(s) <span class="sr-only">(current)</span></a></li>
		<li class="inactive"><a href="../Patient/patient_for_doc.php">View Patients<span class="sr-only">(current)</span></a></li>
		<li class="inactive"><a href="../RDV/rdv_for_doc.php">My Appointments<span class="sr-only">(current)</span></a></li>
		<li class="inactive"><a href="../Secretary/sec_for_doc.php">Available Secretaries<span class="sr-only">(current)</span></a></li>
		<li class="inactive"><a href="../Service/serv_for_doc.php">View Services<span class="sr-only">(current)</span></a></li>
		<li class="inactive"><a href="../Speciality/spec_for_doc.php">View Specialities<span class="sr-only">(current)</span></a></li>
	</ul>
...
<!---NAV END---->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<center><h2 class="page-header">Doctor Records</h2> </center>
			    ...
			    <div class="col-sm-10">
			      <select class="form-control" name="speciality" id="speciality">
					  ...
					  while ($row = $query->fetch_assoc()) {
						echo "<option value=\"$row[specID]\" >".$row['specName']."</option>";
						}
					  ?>
				  </select>
				  <!-- here the text will apper  -->
		...
		<form class="form-horizontal" action="php_action/update.php" method="POST" id="updateMemberForm">	      
	      ...
	      <div class="modal-body">
			...
			<div class="form-group"> <!--/here teh addclass has-error will appear -->
			    ...
			    <div class="col-sm-10"> 
			      <input type="number" class="form-control" id="docID" name="docID" placeholder="ID" readonly>
				<!-- here the text will apper  -->
			    </div>
			  </div>
			<div class="form-group"> <!--/here teh addclass has-error will appear -->
			  ...
			  <div class="form-group">
			    <label for="editSpeciality" class="col-sm-2 control-label">speciality</label>
			    <div class="col-sm-10">
			      <select class="form-control" name="editSpeciality" id="editSpeciality">
				  <option value="">~~SELECT~~</option>
					  <?php
					  $sql = "SELECT * FROM Speciality";
					  $query = $connect->query($sql);
	...
	<script type="text/javascript" src="custom/js/doc.js"></script>
